    ...
    try:
        ...
        with Dataset('data/ERA5_Weather3H.nc', 'r+') as windData_BL:
            for var_name in windData_BL.variables.keys():
                ...
                logging.info('\n')
            u10, v10, tem, dewpoint_temp, sea_temp, total_cloud_cover, total_rain_water, total_snow_water, pressure, = map(windData_BL.variables.get, ['u10', 'v10', 't2m', 'd2m', 'sst', 'tcc', 'tcrw', 'tcsw', 'pres'])
